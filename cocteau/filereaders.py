...
band_files = {
    ...
    'B-band': ['norm', 'Swift', 'Swift_UVOT.B.dat'],
    'U-band': ['norm', 'Swift', 'Swift_UVOT.U.dat'],
    'UVM2'  : ['norm', 'Swift', 'Swift_UVOT.UVM2.dat'],
    'UVW1'  : ['norm', 'Swift', 'Swift_UVOT.UVW1.dat'],
    'UVW2'  : ['norm', 'Swift', 'Swift_UVOT.UVW2.dat'],
    'V-band': ['norm', 'Swift', 'Swift_UVOT.V.dat'],
    'white':  ['norm', 'Swift', 'Swift_UVOT.white.dat'],
